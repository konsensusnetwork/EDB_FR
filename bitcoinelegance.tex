...
% End notes
\AtNextEndnotesList{\footnotesize La rédaction de cet ouvrage s'est terminée le 30 novembre 2023. Les traductions des textes en anglais sont celles de l'auteur, hormis quand le titre français est précisé en note. Les dates et heures sont données selon le fuseau UTC, sauf indication contraire. Des notes supplémentaires peuvent être retrouvées à l'adresse \url{https://viresinnumeris.fr/bitcoinelegancenotes.pdf}.\par}
%\printendnotes
